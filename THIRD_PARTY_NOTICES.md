...
| Tianji-Wuji2 URDF and STL meshes | `assets/tianji_wuji2/` (byte hashes in `SHA256SUMS`; URDF declares Marvin M6-S) | Vendor-provided research assets; TianJi's public Marvin-series page is provenance context only; redistribution permission is **not yet confirmed** |
